...
class DatabaseHelper:
    utilization_by_task_columns: dict[str, str] = {
    ...
    utilization_by_resource_columns: dict[str, str] = {
        "id": "INTEGER PRIMARY KEY AUTOINCREMENT",
        "project": "TEXT",
        "week": "TEXT",
        "resource_name": "TEXT",
    ...
    defect_summary_columns: dict[str, str] = {
        "id": "INTEGER PRIMARY KEY AUTOINCREMENT",
        "project": "TEXT",
        "week": "TEXT",
        "defect_id": "TEXT",
    ...
    def save_data(self, table_name: str, columns: dict, data: list[tuple]) -> None:
        placeholders: str = ", ".join(
            ["?" for _ in range(len(list(columns.keys())[1:]))]
        )
    ...
    def update_data(
        self, table_name: str, set_clause: str, where_clause: str, params: tuple
    ) -> None:
